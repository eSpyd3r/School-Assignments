...
public class BeeColony extends Frame {
    ...
    private void spawnHornet() {
        ...
        System.out.println("trying to spawn hornet");
    ...
    private void createButtons(Panel buttonPanel) {
        ...
        spawnBtn = new Button("Spawn BeeShit.Hornet");
