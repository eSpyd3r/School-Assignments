...
public class MiniTester {
    ...
    private static void honeyBeeTest2() {
        ...
        if (bee1.equals(bee2)) {
            System.out.println("BeeShit.HoneyBee: equals() doesn't compare two honeybees correctly.");
            containsError = true;
        }
    }
    ...
    private static void hornetTest1() {
        ...
        if (!hornet.takeAction()) {
            System.out.println("BeeShit.Hornet: takeAction() returns the wrong value. Expected: true, actual: false");
            containsError = true;
        }
        if (bee.getHealth() != 3) {
            System.out.println("BeeShit.Hornet: takeAction() does the wrong amount of damage to bee. " +
                    "Expected: 3, actual: "+bee.getHealth());
            containsError = true;
        }
    }
    ...
    private static void hornetTest2() {
        ...
        Hornet hornet = new Hornet(t, 10, 2);
        if (hornet.takeAction()) {
            System.out.println("BeeShit.Hornet: takeAction() returns the wrong value. Expected: false, actual: true");
            containsError = true;
        }
    }
    ...
    private static void hornetTest3() {
        ...
        if (!h1.equals(h2)) {
            System.out.println("BeeShit.Hornet: equals() doesn't compare two hornets correctly. ");
            containsError = true;
        }
    }
    ...
    private static void hornetTest4() {
        ...
        if (hornet.getHealth() != 10) {
            System.out.println("BeeShit.Hornet: Health is initialized to a wrong value. " +
        ...
        try {
            ...
            if (!damageField) {
                System.out.println("BeeShit.Hornet: Damage is initialized to a wrong value. (expected: 2)");
                containsError = true;
            }
    ...
    private static void insectTest1() {
        ...
        if (!exceptionCaught) {
            System.out.println("BeeShit.Insect: Constructor incorrectly deals with the case of " +
    ...
    private static void insectTest2() {
        ...
        if (insect.getHealth() != 5) {
            System.out.println("BeeShit.Insect: getHealth() returns the wrong health. Expected: 5, actual: "+insect.getHealth());
            containsError = true;
        }
    }
    ...
    private static void insectTest3() {
        ...
        if (t != insect.getPosition()) {
            System.out.println("BeeShit.Insect: getPosition() returns the wrong BeeShit.Tile.");
            containsError = true;
        }
    }
    ...
    private static void insectTest4() {
        ...
        if (t2 != insect.getPosition()) {
            System.out.println("BeeShit.Insect: setPosition() incorrectly sets the position BeeShit.Tile.");
            containsError = true;
        }
    }
    ...
    private static void insectTest5() {
        ...
        bee.takeDamage(2);
        if (bee.getHealth() != 4) {
            System.out.println("BeeShit.Insect: takeDamage() does the wrong amount of damage to itself.");
            containsError = true;
        }
    }
    ...
    private static void insectTest6() {
        ...
        if (bee1.equals(bee2)) {
            System.out.println("BeeShit.Insect: equals() doesn't compare two insects correctly.");
            containsError = true;
        }
    }
    ...
    private static void angryBeeTest1() {
        ...
        Hornet hornet = new Hornet(t, 10, 2);
        if (!bee.takeAction()) {
            System.out.println("BeeShit.AngryBee: takeAction() returns the wrong value. (expected: true, actual: false)");
            containsError = true;
        }
        if (hornet.getHealth() != 8) {
            System.out.println("BeeShit.AngryBee: takeAction() does the wrong amount of damage to hornet. " +
    ...
    private static void angryBeeTest2() {
        ...
        AngryBee bee = new AngryBee(t, 2);
        if (bee.takeAction()) {
            System.out.println("BeeShit.AngryBee: takeAction() returns the wrong value. Expected: false, actual: true");
            containsError = true;
        }
    }
    ...
    private static void angryBeeTest3() {
        ...
        if (bee1.equals(bee2)) {
            System.out.println("BeeShit.AngryBee: equals() doesn't compare two angry bees correctly.");
            containsError = true;
        }
    }
    ...
    private static void angryBeeTest4() {
        ...
        AngryBee bee = new AngryBee(t, 2);
        if (bee.getHealth() != 10) {
            System.out.println("BeeShit.AngryBee: Health is initialized to a wrong value. " +
                    "Expected: 10, actual: "+bee.getHealth());
            containsError = true;
        }
        if (bee.getCost() != 1) {
            System.out.println("BeeShit.AngryBee: Food cost is initialized to a wrong value. " +
        ...
        try {
            ...
            if (!damageField) {
                System.out.println("BeeShit.AngryBee: Damage is initialized to a wrong value. (expected: 2)");
                containsError = true;
            }
        } catch(IllegalAccessException e) {
            e.printStackTrace();
    ...
    private static void swarmOfHornetsTest6() {
        ...
        if (swarm.sizeOfSwarm() != 1 || !Arrays.equals(swarm.getHornets(), expected)) {
            System.out.println(swarm.getHornets().toString());
            System.out.println(expected.toString());
            System.out.println("The fields of the BeeShit.SwarmOfHornets were not modified correctly.");
            containsError = true;
        }
        if (!b) {
    ...
    private static void tankyBeeTest1() {
        ...
        if (hornet.getHealth() != 8) {
            System.out.println("BeeShit.TankyBee: takeAction() does the wrong amount of damage to hornet. " +
                    "Expected: 8, actual: "+hornet.getHealth());
            containsError = true;
        }
    }
    ...
    private static void tankyBeeTest2() {
        ...
        TankyBee bee = new TankyBee(t, 2, 10);
        if (bee.takeAction()) {
            System.out.println("BeeShit.TankyBee: takeAction() returns the wrong value. Expected: false, actual: true");
            containsError = true;
        }
    }
    ...
    private static void tankyBeeTest3() {
        ...
        bee.takeDamage(2);
        if (bee.getHealth() != 29) {
            System.out.println("BeeShit.TankyBee: takeDamage() does the wrong amount of damage to itself. " +
    ...
    private static void tankyBeeTest4() {
        ...
        if (bee1.equals(bee2)) {
            System.out.println("BeeShit.TankyBee: equals() doesn't compare two bees correctly.");
            containsError = true;
        }
    }
    ...
    private static void tankyBeeTest5() {
        ...
        TankyBee bee = new TankyBee(t, 2, 10);
        if (bee.getHealth() != 30) {
            System.out.println("BeeShit.TankyBee: Health is initialized to a wrong value. " +
                    "Expected: 30, actual: "+bee.getHealth());
            containsError = true;
        }
        if (bee.getCost() != 3) {
            System.out.println("BeeShit.TankyBee: Food cost is initialized to a wrong value. " +
        ...
        try {
            ...
            if (!damageField) {
                System.out.println("BeeShit.TankyBee: Damage is initialized to a wrong value. (expected: 2)");
                containsError = true;
            }
            if (!armorField) {
                System.out.println("BeeShit.TankyBee: Armor is initialized to a wrong value. (expected: 10)");
                containsError = true;
            }
        } catch(IllegalAccessException e) {
            e.printStackTrace();
    ...
    private static void tileTest9() {
        ...
        if (tt.getHornet() != hor1) {
            System.out.println(tt.getHornet());
    ...
    private static void tileTest14() {
        ...
        if (!tt.removeInsect( bee )) {
            System.out.println("this is tileTest14");
